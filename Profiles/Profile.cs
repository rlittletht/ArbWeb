...
namespace ArbWeb
{
	public class Profile
	{
		...
		[Setting("BaseballScheduleFiles", new string[] { }, new string[] { })]  public string[] BaseballSchedFiles { get; set; }
		[Setting("SoftballScheduleFiles", new string[] { }, new string[] { })]  public string[] SoftballSchedFiles { get; set; }
		[Setting("SchedSpoSite", "", "")]                                       public string SchedSpoSite { get; set; }
		[Setting("SchedSpoSubsite", "", "")]                                    public string SchedSpoSubsite { get; set; }
		[Setting("SchedDownloadFolder", "", "")]                                public string SchedDownloadFolder { get; set; }
		[Setting("SchedWorkingFolder", "", "")]                                 public string SchedWorkingFolder { get; set; }
		[Setting("NoHonorificRanks", false, 0)]                                 public bool NoHonorificRanks { get; set; }
		[Setting("LastLogLevel", 0, 0)]                                         public int LogLevel { get; set; }
		[Setting("GameFiltersCache", new string[] { }, new string[] { })]       public string[] GameFilters { get; set; }
		[Setting("LastGameFilter", "", "All Games")]                            public string GameFilter { get; set; }
		...
		[Setting("LastOpenSlotDetail", false, 0)]                               public bool OpenSlotDetail { get; set; }
		[Setting("LastGroupTimeSlots", false, 0)]                               public bool FuzzyTimes { get; set; }
		[Setting("LastTestEmail", false, 0)]                                    public bool TestEmail { get; set; }
		[Setting("LastLogToFile", false, 0)]                                    public bool LogToFile { get; set; }
		[Setting("FilterMailMergeByRank", false, 0)]                            public bool FilterRank { get; set; }
		[Setting("AddOfficialsOnly", false, 0)]                                 public bool AddOfficialsOnly { get; set; }
		...
		[Setting("DownloadRosterOnUpload", false, 0)]                           public bool DownloadRosterOnUpload { get; set; }
		[Setting("LastMainWindowPos.Top", 0, 0)]                                public int MainWindowTop { get; set; }
		[Setting("LastMainWindowPos.Left", 0, 0)]                               public int MainWindowLeft { get; set; }
		[Setting("LastMainWindowPos.Width", 0, 0)]                              public int MainWindowWidth { get; set; }
		[Setting("LastMainWindowPos.Height", 0, 0)]                             public int MainWindowHeight { get; set; }
		[Setting("LastProfileWindowPos.Top", 0, 0)]                             public int ProfileWindowTop { get; set; }
