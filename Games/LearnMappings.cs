...
namespace ArbWeb.Games
{
    public class LearnMappings
    {
        public class MapAndConfidences
        {
            ...
            private Dictionary<string, Dictionary<string, ConfidenceVal>> m_mapAndConfidencesLeftToRight =
                new Dictionary<string, Dictionary<string, ConfidenceVal>>();

            private Dictionary<string, Dictionary<string, ConfidenceVal>> m_mapAndConfidencesRightToLeft =
                new Dictionary<string, Dictionary<string, ConfidenceVal>>();
...
//			Dictionary<DateTime, List<SimpleGame>> gamesByTimeLeft = GroupGamesByDate(scheduleLeft);
            ...
            return new ScheduleMaps(
                learner.m_teamMapAndConfidences,
                learner.m_siteMapAndConfidences,
                learner.m_gameTagMapAndConfidences,
                learner.m_sportMapAndConfidences);
        }
        ...
        ----------------------------------------------------------------------------*/
        public void WriteLearningsToFile(
            string sSiteFileLTR, string sSiteFileRTL, string sTeamFileLTR, string sTeamFileRTL, string sNumberFileLTR, string sNumberFileRTL)
        {
